...
From here, it's very self explanatory. Look in SlackTool-config.ini to see what hotkeys are mapped. Refer to WizWalker's constants.py for names of keys.

To remap keys, simply replace the key's name with the desired key in the config. Save your changes, then kill and relaunch the tool.
