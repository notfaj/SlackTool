...
path1 = ["WorldView","compareNewItem","ControlWidge","mainLayout","ControlText"]
path2 = ["WorldView","compareNewItem","ControlWidge","text"]
path3 = ["WorldView","compareNewItem","spellText"]
...
class SlackQuester():
	...
	async def auto_quest(self):
		...
		#return
		#while True:-- [compareNewItem] Window

		txtmsg = await self.get_window_from_path(self.client.root_window, path3)
		print(txtmsg)
		return
