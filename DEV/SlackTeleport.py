import asyncio
import wizwalker
from wizwalker import WizWalker, XYZ, Keycode
...
class SlackTeleport():
	...
	def calc_PointOn3DLine(self, xyz_1, xyz_2, additional_distance):
	...
	def calc_multiplerPointOn3DLine(self, xyz_1, xyz_2, multiplier):
	...
	def calc_MidPoint(self, xyz_1, xyz_2, distance_multiplier=0.5):
		# calculates the midpoint of 2 XYZs. 
		distance = math.sqrt((pow(xyz_1.x - xyz_2.x, 2.0)) + (pow(xyz_1.y - xyz_2.y, 2.0)) + (pow(xyz_1.z - xyz_2.z, 2.0)))
		n = distance_multiplier
		return XYZ(x=((xyz_2.x - xyz_1.x) * n) + xyz_1.x, y=((xyz_2.y - xyz_1.y) * n) + xyz_1.y, z=((xyz_2.z - xyz_1.z) * n) + xyz_1.z)

	def calc_AveragePoint(self, xyz_list):
	...
	def rotate_point(self, origin_xyz, point_xyz, theta):
	...
	def are_xyzs_within_threshold(self, xyz_1, xyz_2, threshold=200):
	...
	def calc_Distance(self, xyz_1, xyz_2):
	...
	def calc_squareDistance(self, xyz_1, xyz_2):
	...
	async def calc_up_XYZ(self, xyz=None, speed_constant=580, speed_adjusted=True):
	...
	async def calc_FrontalVector(self, xyz=None, yaw=None, speed_constant=580, speed_adjusted=True, length_adjusted=True):
	...
	async def teleport_move_adjust(self, xyz, delay=0.8):
	...
	async def is_teleport_valid(self, destination_xyz, origin_xyz):
	...
	def calc_angle(self, p1, p2, p3=None):
		if not p3:
